const app = {
    ...
    elementDataList: document.getElementById('user_edit_city'),
    elementInputZipcode: document.getElementById('user_edit_zipCode'),
    ...
    api : function(){
        const zipcode = document.getElementById('user_edit_zipCode').value;
    ...
    listen: function(){
        const select = document.querySelector('#user_edit_city');
    ...
    loadCitiesIfZipCode : function() {
        let zipeCodeValue = document.querySelector('#user_edit_zipCode').value;
        let cityValue = document.querySelector('#user_edit_city');
    ...
    init : function(){
        document.getElementById('user_edit_zipCode').addEventListener('keyup',app.api);
